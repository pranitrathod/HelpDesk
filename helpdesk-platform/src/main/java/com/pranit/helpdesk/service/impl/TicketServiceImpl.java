...
public class TicketServiceImpl implements TicketService {
  ...
  @Transactional(readOnly = true)
  public LocationResponse location(Long ticketId) {
    ticket(ticketId);
    TicketLocation location = locations.findByTicketId(ticketId).orElseThrow(
        () -> new ResourceNotFoundException("Location for ticket", ticketId));
    return new LocationResponse(
        ticketId, location.getLatitude(), location.getLongitude(), location.getAddress());
  }
